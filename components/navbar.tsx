          ...
          <div className="hidden md:flex items-center space-x-4">
            {session ? (
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  ...
                  {(userRole === 'admin' || userRole === 'root' || userRole === 'adder') && (
                    <DropdownMenuItem asChild>
                      <Link href="/dashboard"><Shield className="mr-2 h-4 w-4" /><span>Panel</span></Link>
                    </DropdownMenuItem>
                  )}
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-emerald-600 to-emerald-400 hover:from-emerald-700 hover:to-emerald-500 text-white font-medium px-6 py-2 rounded-lg transition-all duration-200"
              >
                {isLoggingIn ? (
              ...
              <div className="pt-4 border-t border-white/10">
                {session ? (
                    ...
                    <Button 
                        onClick={handleLogin}
                        disabled={isLoggingIn}
                        className="w-full bg-gradient-to-r from-emerald-600 to-emerald-400 hover:from-emerald-700 hover:to-emerald-500 text-white font-medium"
                    >
                       {isLoggingIn ? (
                            <Loader2 className="w-5 h-5 animate-spin" />
                        ) : (
