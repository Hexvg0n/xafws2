...
const heroImages = [
  ...
  "/placeholder.svg?height=520&width=340",
  "/placeholder.svg?height=480&width=310",
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Odkryj najlepsze <span className="gradient-text">repliki</span> w Polsce
            </motion.h1>
          ...
          >
            <div className="glass-morphism rounded-2xl p-8 relative overflow-hidden">
              <ParallaxScroll images={heroImages} className="h-[600px]" />

              {/* Overlay gradient */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent rounded-2xl" />

              {/* Floating badge */}
              <div className="absolute top-4 right-4 bg-blue-400/20 backdrop-blur-md border border-blue-400/30 rounded-full px-3 py-1">
                <span className="text-blue-400 text-sm font-medium">Na Żywo</span>
              </div>
            </div>
          </motion.div>
        </div>
